...
pub mod voxel_mesh {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_ambient_occlusion_strength(&mut self, value: ::capnp::primitive_list::Reader<'a,f32>) -> ::capnp::Result<()> {
    ...
    #[inline]
    pub fn set_static_sides(&mut self, value: ::capnp::struct_list::Reader<'a,crate::schemas::voxel_mesh_capnp::voxel_mesh_side::Owned>) -> ::capnp::Result<()> {
...
pub mod voxel_mesh_side {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vertices(&mut self, value: ::capnp::struct_list::Reader<'a,crate::schemas::voxel_mesh_capnp::voxel_mesh_vertex::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    ...
    #[inline]
    pub fn set_indices(&mut self, value: ::capnp::primitive_list::Reader<'a,u16>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
...
pub mod voxel_mesh_vertex {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_ambient_occlusion_neighbors(&mut self, value: ::capnp::struct_list::Reader<'a,crate::schemas::game_types_capnp::i_vec3::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
