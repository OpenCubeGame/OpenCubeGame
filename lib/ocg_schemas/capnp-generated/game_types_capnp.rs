...
pub mod option { /* T */
  ...
  impl <'a,T> Builder<'a,T> where T: ::capnp::traits::Owned  {
    ...
    #[inline]
    pub fn set_some(&mut self, value: <T as ::capnp::traits::Owned>::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 0);
...
pub mod result { /* Ok,Err */
  ...
  impl <'a,Ok,Err> ::capnp::traits::SetPointerBuilder for Reader<'a,Ok,Err> where Ok: ::capnp::traits::Owned, Err: ::capnp::traits::Owned  {
    fn set_pointer_builder(mut pointer: ::capnp::private::layout::PointerBuilder<'_>, value: Self, canonicalize: bool) -> ::capnp::Result<()> { pointer.set_struct(&value.reader, canonicalize) }
  }
  ...
  impl <'a,Ok,Err> Builder<'a,Ok,Err> where Ok: ::capnp::traits::Owned, Err: ::capnp::traits::Owned  {
    ...
    #[inline]
    pub fn set_ok(&mut self, value: <Ok as ::capnp::traits::Owned>::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 0);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    ...
    #[inline]
    pub fn set_err(&mut self, value: <Err as ::capnp::traits::Owned>::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 1);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
...
pub mod version {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_prerelease(&mut self, value: ::capnp::text::Reader<'_>)  {
    ...
    #[inline]
    pub fn set_build(&mut self, value: ::capnp::text::Reader<'_>)  {
